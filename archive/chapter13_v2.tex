...
\begin{enumerate}
    \item \textbf{Phonemes}: If mergers showed no relationship to cue reliability~-- if vowel mergers occurred in environments where acoustic cues are robust rather than degraded~-- the homeostasis story would be wrong.
