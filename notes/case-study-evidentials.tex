...
\subsection{The wider ecology: areal pressure and pragmatic function}

If mechanisms explain \emph{how} categories stabilise, we should also ask: what environmental factors push mechanisms in different directions? Why did Turkish develop tight grammaticalisation while Japanese maintained a looser system?

Here, as with quotatives, we need to distinguish mechanisms from the ecology in which they operate.

\textbf{Areal contact and the Eurasian evidential belt.} Turkish is not an isolate. It sits within a "Eurasian evidential belt" stretching from the Balkans through the Caucasus to Central Asia, where grammaticalised indirect evidentiality is unusually common. Bulgarian and Macedonian developed similar evidential systems -- in part, typologists argue, through prolonged contact with Turkish during Ottoman rule. The Tibetan languages show convergent patterns through contact in the Himalayan zone.

Evidentiality, it turns out, is highly diffusible. When languages are in sustained contact, evidential distinctions spread. This is not a mechanism of grammaticalisation per se -- the mechanisms are still frequency, paradigmatic contrast, prosodic integration. But areal contact creates the \emph{conditions} under which these mechanisms operate: multilingual speakers code-switch; bilingual children receive input that reinforces evidential marking; prestige varieties entrench obligatory contrasts.

If Turkish speakers over centuries heard evidential contrasts in the languages around them -- and if those contrasts were reinforced by Ottoman administrative and literary norms -- the grammaticalisation mechanisms had a tailwind. The ecology amplified the mechanisms.

\textbf{Pragmatic ecology: evidentials as hedges.} Japanese, by contrast, operates in a different pragmatic environment. The forms that mark information source -- \mention{rashii}, \mention{sōda}, \mention{yōda} -- do double duty: they encode evidence \emph{and} they encode hedging. In a communicative culture where directness risks face-loss, these forms allow speakers to assert without asserting too strongly. They say "it seems that" rather than "it is".

This functional overlap has stabilising consequences. It maintains the forms' semi-independence: they can't fuse fully into the verb because they need to be deployable for politeness as much as for evidentiality. The pragmatic ecology -- a culture of indirect assertion, elaborate politeness registers, sensitivity to speaker commitment -- preserves the looser architecture.

This is a selection environment, not a mechanism. The mechanisms (frequency, paradigmatic structure, prosodic integration) are the same in Japanese as in Turkish. But the pragmatic environment steers them toward a different equilibrium: semi-grammaticalised forms that serve multiple masters.

\textbf{What areal and pragmatic ecology don't explain.} These ecological factors explain why Turkish and Japanese differ in the \emph{degree} and \emph{architecture} of evidentiality. They don't explain why evidentiality exists at all. The communication need -- marking information source -- is universal. The mechanisms that stabilise categories are universal. What varies is the tuning.

Areal contact doesn't create the mechanisms; it amplifies their effects. Pragmatic ecology doesn't create the forms; it shapes which equilibrium the forms settle into. The ecology is the wind; the mechanisms are the sails.

\textbf{A prediction.} If this framing is right, we'd expect languages \emph{entering} the Eurasian evidential zone through migration or contact to develop stronger evidential grammaticalisation over time. And we'd expect languages whose pragmatic ecology shifts -- say, toward more direct communication norms -- to see their evidential hedges narrow in function. The architecture should track the ecology, because the ecology modulates which mechanism configurations are favoured.
...
The comparison between Turkish and Japanese shows that the same semantic territory can be stabilized differently. The difference is not in what speakers need to express. It's in how the stabilising mechanisms interact.
