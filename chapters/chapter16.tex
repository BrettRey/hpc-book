...
\label{sec:16:nominalism}

Chapter~\ref{ch:social-stabilization} addressed the nominalist challenge directly; the social mechanisms that maintain kinds are themselves part of what makes kinds real. What remains is to ask what changes \emph{methodologically} when we take the maintenance view seriously.
