...
Recall from Chapter~\ref{ch:what-we-havent-been-asking} that a noun doesn't \emph{have} a gender the way it has a phonological form~-- gender is a system, and the noun is assigned a value within that system. The same holds for the properties that cluster in any HPC: they are relational, defined by position in a system of contrasts. What mechanisms maintain is not just clustering but coupling~-- the reliable pairing of a form's distribution with its systemic contribution.
