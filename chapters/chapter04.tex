...
that's the handoff. If categories are maintained, then their boundaries must be maintained too. And if boundaries are maintained, we can ask what kind of sharpness a maintained boundary can have~-- sharp in structure, yet difficult to locate; stable under ordinary perturbations, yet sensitive near the seam. Chapter~\ref{ch:dynamic-discreteness} argues that this is exactly what we should expect, and shows how to make the expectation precise enough to test.
