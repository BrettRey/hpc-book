...
We've been framing this negatively~-- kinds \emph{without} essences. But the positive formulation matters more: kinds \emph{with} mechanisms. From here on, the vocabulary shifts. The question is no longer what categories lack but what maintains them. Think of the chapter title as the door you entered through; by the time you leave, you should be thinking not \enquote{no essences} but \enquote{maintained kinds.}
