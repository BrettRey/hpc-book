...
Part I raised a question: if categories aren't defined by essences, what makes them real? The answer this chapter develops is simple: categories are real because they are maintained. This is the \ixs{maintenance view}\term{maintenance view}. The maintenance view finds a natural ally in the Parallel Architecture \parencite{jackendoff2002, jackendoff2010meaning}, which treats the lexicon not as a list of exceptions but as the very heart of the interface machinery.
