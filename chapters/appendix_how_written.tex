...
ChatGPT 5.1 served as the primary outside critic. Where Opus helped develop ideas, ChatGPT's role was adversarial: to find the holes, to push back, to ask what would falsify the claims I was making. I also consulted the newest versions of Grok and Kimi, each of which brought different sensibilities to the work. A kind of editorial board, except that I could convene them at 5:30 a.m. and they never complained about the length of my drafts. But the value was more than convenience. At Humber, I have no linguistics department, no colleagues down the hall with whom to kick around ideas. Sending work to peers elsewhere means waiting weeks or months for feedback that, given their own commitments, is often cursory. The models offered what human colleagues couldn't: immediate, iterative, tireless engagement. They allowed me to have the back-and-forth of a seminar room in the solitude of my early mornings.
