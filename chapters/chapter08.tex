...
\citet[25--26]{miller2021} provides a useful operationalisation. Whether a novel form counts as a \enquote{word-kind} depends on whether stabilising mechanisms~-- internal (cognitive) and external (social)~-- have emerged to maintain it as more than a one-off performance. Consider \mention{cromulent}, coined for a 1996 \emph{Simpsons} episode to mean \enquote{acceptable, fine.}
...
A quick illustration. \mention{Furniture} is a good similarity class, but English grammar mostly ignores it. \term{Animacy} is the reverse: it drives robust grammatical contrasts (\mention{who} vs \mention{what}, \mention{he/she} vs \mention{it}) while cutting across many conceptual domains. And inferential groupings like \term{factivity} organise items by what they commit you to infer, cutting across similarity and leaving a mixed grammatical footprint.
