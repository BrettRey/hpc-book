...
\citet[25--26]{miller2021} provides a useful operationalisation. Whether a novel form counts as a \enquote{word-kind} depends on whether stable mechanisms~-- internal (cognitive) and external (social)~-- have emerged to maintain it. Consider \term{cromulent}, coined for a 1996 television episode to mean \enquote{acceptable, fine.}
