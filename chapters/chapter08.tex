...
\noindent Note that interest-relativity is not a failure mode. Different analysts tracking different stabilizer-backed clusters should use different labels~-- that's the framework working correctly. A fat class arises when one label is forced to cover divergent subclusters rather than acknowledged as multiple HPCs.
