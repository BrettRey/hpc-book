...
\begin{exe}
    ...
    \ex[]{\label{ex:12:dog-chain-c} \mmark{\textit{That's the dog which attacked his owner.}} \hfill [mixed]}
    \ex[]{\label{ex:12:dog-chain-d} \mmark{\textit{That's the dog who attacked its owner.}} \hfill [mixed]}
\end{exe}
...
\begin{exe}
    \ex[]{\label{ex:12:which-he} \mmark{\textit{That's the dog which attacked his owner.}}}
\end{exe}
...
\begin{exe}
    \ex[]{\label{ex:12:what-he} \mmmark{\textit{What attacked his owner was this dog.}}}
