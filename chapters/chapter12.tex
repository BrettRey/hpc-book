...
\begin{exe}
    \ex \label{ex:12:int-who} \textit{Who's coming to the party?} \hfill [asking about persons]
    \ex \label{ex:12:int-what} \textit{What's in your purse?} \hfill [asking about non-persons]
    \ex \label{ex:12:int-who-bad} \ungram{\textit{Who's in your purse?}} \hfill [under construal: asking about objects]
    \ex \label{ex:12:int-what-bad} \ungram{\textit{What's coming to the party?}} \hfill [under construal: asking about persons]
\end{exe}
...
\begin{exe}
    ...
    \ea[*]{\gll \textit{Las patatas fritas} esperan. \textit{Él} está enfadado.\\
...
\begin{exe}
    \ex \label{ex:12:team-themself} \mmark{\textit{The team has scored on themselves.}}
\end{exe}
