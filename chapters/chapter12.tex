...
The English system differs from antecedent-driven systems in a crucial way. In Spanish, French, or German, gender assignment is fixed on nouns and agreement spreads through NP-internal morphology. The antecedent controls the pro-form.
...
In Chapter~\ref{ch:stabilizers}, we surveyed the general machinery that maintains linguistic kinds. For pro-form gender, three mechanisms do the heaviest work.
