...
\ea[{}]{\label{ex:12:which-chain}\mmark{\mention{The dog which attacked the farmer ran away. He was never caught by the police.}} \hfill [upgrade within chain]}
\z
...
But \mention{what} in free relatives and \mention{something} are systematically underspecified. They lack a full NP antecedent, so there is less material for hearers to anchor a promoted personal construal:

\ea[{}]{\label{ex:12:what-chain}\mmmark{\mention{What attacked the farmer ran away. He was never caught by the police.}}}
\z
\ea[{}]{\label{ex:12:something-chain}\mmmark{\mention{Something attacked the farmer. He was never caught by the police.}} \hfill [with coreference]}
\z
The contrast, if these judgments hold up, is not simple gradience within the non-personal domain; it's a difference in discourse anchoring. Relative \mention{which} points to an existing NP that can sometimes be ``upgraded''; \mention{what} and \mention{something} provide no such anchor, so the chain more strongly resists promotion to personal. The mechanism that stabilizes the pattern is chain coherence: when the anchor is weak, shift is blocked or sharply degraded.
