...
\epigraph{Obstinately and unswervingly, the mechanism follows its own rule.}{Hermann von Helmholtz, \textit{Helmholtz's Treatise on Physiological Optics}, vol. 3.}
...
Entrenchment doesn't just tune the detector; it shapes what counts as grammatical in the first place. The form--value coupling is itself entrenched, and that entrenchment is language-specific, construction-specific, even register-specific.
