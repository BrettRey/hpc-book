...
If grammaticality is a maintained coupling and acceptability is a noisy detector, then the evidential status of the asterisk changes. It is not a report from an oracle; it is a signal from a measuring instrument~-- informative, but fallible, and calibrated to the community in which it was trained. What this means for how we do linguistics~-- for evidence, argumentation, and the rhetoric of theoretical debate~-- is the subject of the final chapter.
