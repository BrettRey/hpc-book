...
German has three genders. Swahili has eighteen noun classes. When we call both \enquote{gender\ixsq{gender} systems}, what are we claiming? That the languages share a natural kind\ixsq{kind}? Or that linguists have found it useful to file them in the same drawer?
...
Croft pushes the skepticism deeper. In \citet{croft2001}, he argues that even within a single language, broad categories like \textsc{subject\ixsq{subject}} or \textsc{noun\ixsq{noun}} are illusions. There is no global category\ixsq{category} of Subject in English; there is only the subject-of-the-intransitive, the subject-of-the-transitive, the subject-of-the-passive\ixsq{passive}. The only real grammatical units are specific \term{construction\ixsq{construction}}s. Everything else is a generalization we make over them.

The position is carefully stated. Haspelmath doesn't deny that German has gender\ixsq{gender}. He denies that German gender\ixsq{gender} and Swahili noun\ixsq{noun} classes instantiate the same mental category. Croft doesn't deny that English subjects behave similarly. He denies that this similarity implies a single underlying mental object. When typologists group them under a common label, they are constructing a yardstick for measurement, not uncovering a shared essence.
...
If \textsc{gender\ixsq{gender}} is a \term{comparative concept\ixsq{comparative concept}} and nothing more, then German gender and Swahili noun\ixsq{noun} classes share only the properties we have chosen to include in our yardstick. The resemblance is constructed, not discovered. And if \textsc{noun\ixsq{noun}} is a \term{comparative concept\ixsq{comparative concept}}~-- if there is no cross-linguistic natural kind\ixsq{kind} that English nouns and Mandarin nouns both instantiate~-- then the apparent universality of the noun\ixsq{noun}-verb\ixsq{verb} distinction is an artifact of our filing system, not a fact about the human language faculty.
...
Consider \textsc{definiteness\ixsq{definiteness}}~-- a case I'll return to in detail in Chapter~\ref{ch:definiteness-and-deitality}. The textbook definition says that definite expressions pick out referents identifiable to the hearer. English \mention{the} is the paradigm case. But \mention{the} appears in contexts where identifiability\ixsq{identifiability} fails: \mention{the hospital} in \mention{go to the hospital}, \mention{the tiger} in \mention{the tiger is endangered}, \mention{the average American} in statistical generalizations. Are these counterexamples to the definition, or extensions licensed by some deeper principle, or evidence that \textsc{definiteness\ixsq{definiteness}} isn't a unified kind\ixsq{kind} at all?
...
The essentialism\ixsq{essentialism}-nominalism\ixsq{nominalism} debate has focused on lexical categories: \textsc{noun}, \textsc{verb}, \textsc{adjective}, \textsc{preposition}. These are categories of items. The disputed cases are words~-- \mention{fun}, \mention{near}, \mention{otherwise}~-- and the question is which category\ixsq{category} they belong to.
