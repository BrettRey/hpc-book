...
This captures the phenomenology. But it faces the same explanatory gap we've seen before. If grammaticality is gradient, why is the gradient stable? Why do speakers agree, when they do agree? Why don't judgments drift randomly across generations? What maintains the shape of the acceptability landscape?
