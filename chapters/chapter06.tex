...
\label{sec:6:constituency-dependency}
...
Chapter~\ref{ch:the-category-zipper} then zooms out, showing how coupling tightness varies across the linguistic hierarchy~-- from the hard-coupled acoustic-distributional bundle of phonemes to the loose-coupled semantic-morphosyntactic profiles of grammatical categories.
