...
Now the maintenance view snaps into focus.
...
Consider: you've learned \mention{robić} (impf) / \mention{zrobić} (pf)~-- to do, to accomplish. You encounter an unfamiliar verb \mention{pływać}~-- to swim. How do you know that \mention{przepływać} will be perfective?
