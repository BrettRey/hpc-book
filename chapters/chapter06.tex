...
\caption{The mechanism-based view of aspectual projectibility. Instead of applying semantic definitions, learners extract cue-outcome associations~-- morphological patterns, tense contexts, lexical biases~-- that allow prediction of novel forms. The question this answers is not \enquote{what does aspect mean?} but \enquote{what maintains aspectual patterns?}}
