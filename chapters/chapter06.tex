...
Chapter~\ref{ch:kinds-without-essences} compressed the maintenance view into a slogan: \emph{profile, stabilised by mechanisms, projectible relative to purposes}. This chapter unpacks each component and tests them against Polish aspect.
