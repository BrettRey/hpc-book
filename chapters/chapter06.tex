...
\caption{Box-and-whisker plots showing acceptability ratings for Polish syntactic variants by verb frequency quartile. As frequency drops (left to right), the whiskers widen dramatically~-- variance increases where entrenchment is weak. Reproduced from \citet{divjak2017}; permission pending.}
