...
The failure is diagnostic. When a proposed characterisation fails to project~-- when the textbook definition doesn't predict behaviour~-- that's evidence that the characterisation doesn't track the mechanisms. The category remains descriptively real; what fails is the assumption that its textbook semantic essence is what makes it project.
