...
Finally, the landscape is already shaped~-- and kept that way. For most verbs, learning the verb means entering a valley that ongoing use keeps deep. The category isn't applied at the point of utterance; it's maintained by the same forces that carved it.
