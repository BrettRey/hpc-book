...
When computational models trained on those definitions try to predict which aspect Polish speakers actually use, they fail~-- 77\% accuracy for perfective, against 98\% for imperfective \citep{divjak2024aspect}. The definitions that have been taught for generations capture only half the system. Something is projectible about aspect; it just isn't what the textbooks say.
