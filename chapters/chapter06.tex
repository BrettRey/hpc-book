...
First, it legitimises mechanistic work as theory, not just description. A sceptic might object that studying entrenchment or alignment is interesting but atheoretical~-- that eventually someone will come along with the definitions, and the mechanism-talk will become scaffolding to be discarded. The maintenance view says: no. The mechanisms \emph{are} the theory. Understanding how categories are maintained is understanding what makes them real. This is analogous to recognising that natural selection isn't ``just'' a description of breeding patterns but the actual explanation of adaptation.
