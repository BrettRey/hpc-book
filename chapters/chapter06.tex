...
This is why the aspect example matters. The semantic definition of \term{perfective}~-- bounded, complete, telic~-- correlates with usage but doesn't determine it; the actual tilts come from verb identity and tense context. Project from the terrain and you succeed; project from the definitions and you're left predicting imperfective while Polish speakers are saying perfective. A category can look like a good bet and still turn out to be a turkey.
