...
% TODO: CONCEPTUAL ISSUE — This section claims aspect patterns are real but mechanism lives below label.
% Tension: if projectibility tests category-hood and aspect isn't projectible, is aspect still a category?
% Needs clearer commitment: (A) aspect is a category at mechanism level, or (B) aspect isn't a real category.
