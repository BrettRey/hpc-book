...
The stronger hypothesis is convergent development under similar functional pressures. The evidence for this is suggestive rather than conclusive, but the pattern is striking: the semantic-pragmatic sources for innovative quotatives~-- deictic markers, movement verbs, approximation expressions~-- recur across typologically unrelated languages \autocite{guldemann2008}. German recruits \mention{so} (a deictic), Japanese recruits \mention{tte} (a reduced quotative verb), Turkish recruits \mention{diye} (a converb), English recruits \mention{like} (a preposition). The sources differ, but the functional territory is the same: introducing vivid, non-verbatim re-enactment in informal narrative.
