...
\textbf{Sociolinguistic maintenance.} Some irregular forms persist partly because they're unmarked variants in a prestige register. \mention{Dove} vs \mention{dived}, \mention{snuck} vs \mention{sneaked} -- neither is stigmatised, both are maintained. \mention{Holp} died partly because no community maintained it; there was no prestige or identity value attached to preserving it. But note: social factors are not the dominant constraint on all variation. \citet{weinerlabov1983} showed that the choice between active and passive voice in spontaneous speech is driven primarily by \emph{processing} factors -- coreference, discourse coherence, information structure -- not by social class, gender, or ethnicity. Syntactic alternations can be stabilised by processing mechanisms even when social mechanisms have little effect. The mechanism profile differs by level and by variable.
...
Critically, individual-level variation can seed community-level divergence. \citet{mackenzie2019} documents cases where different speech communities share the same variable but differ in the constraints on it: TD-deletion in York shows different morphological conditioning than in American English; goose-fronting in Manchester responds to following /l/ differently than in most British dialects. These aren't random differences. They reflect cases where individual cognitive or articulatory differences became amplified through transmission, producing stable community-level constraint divergence. The activation-state picture scales: individual variability, filtered by community learning pressures, crystallises into distinct mechanism profiles across populations.
