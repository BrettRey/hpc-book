...
Stability, for grammatical categories, is not given but achieved. The cluster-first strategy applies to grammar directly. The same approach that lets immunologists sidestep definitional impasses can do the same for linguists.
...
This is not coincidence, but convergent maintenance. Independent forms. Same mechanisms. Same architecture.
