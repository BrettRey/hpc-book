...
The quotative case shows convergent maintenance: different languages, same mechanism profile, same category architecture. But the framework should also predict divergence when ecologies differ. To test this, consider a domain where typologically unrelated languages share a function but differ in form.
