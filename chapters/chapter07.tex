...
As mentioned in Chapter~\ref{ch:projectibility}, \citet{boguraev2025} used causal interventions to test whether language models learn a shared mechanism across these construction types. They do: a mechanism learned on embedded open interrogatives transfers to produce filler-gap behaviour in clefts. The result is a proof of concept~-- showing how mechanistic generalisation could work in principle~-- rather than direct evidence about human parsing. But the structural dependency projects even when the surface constructions differ, which is what mechanistic kindhood predicts.
