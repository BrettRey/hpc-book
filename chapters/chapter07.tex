...
The case studies in this chapter aren't meant to supersede the work they draw on: Remijsen's descriptive grammar-building for under-documented languages, Ferrara and Bell's functional analysis of quotative emergence, Tagliamonte's variationist quantification, Buchstaller's cross-variety typology, or Hankamer and Postal's formal constraint analysis. That work provides the data~-- the primary documentation, the functional distinctions, the apparent-time percentages, the global attestation timeline, the grammaticality contrasts. The maintenance view provides a conceptual frame that makes the data cohere.
