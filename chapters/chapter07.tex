...
The same holds for grammatical categories. If your question is \enquote{why do children overgeneralise the English past tense?}, the relevant mechanisms are acquisition dynamics -- exemplar storage, analogical extension, error-driven learning. If your question is \enquote{why does the irregular past tense persist in high-frequency verbs?}, the relevant mechanism is entrenchment. If your question is \enquote{why do some aspect markers grammaticalise faster than others?}, the relevant mechanisms are diachronic -- frequency of source construction, semantic bleaching, paradigm pressure.

These are all real mechanisms. None is more fundamental than the others. The question is not \enquote{which is the true mechanism?} but \enquote{which mechanism answers this question?}

What's illegitimate is choosing a level because it makes your favourite category look real. If you claim that \term{noun} is a natural kind, you need mechanisms that actually stabilise noun-ness across speakers and contexts -- not just a definition that feels satisfying. If the mechanisms point elsewhere -- if the causal work is really being done at the level of animacy, or argument structure, or information packaging -- then the category is a convenient label, not a stabilised kind.
