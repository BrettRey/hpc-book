...
The case studies that follow show how this works in practice~-- first for quotatives, then for filler-gap constructions.
...
\textbf{Cross-linguistic convergence.} German and Japanese~-- despite radically different syntactic structures~-- are reported to show similar information-structural constraints on independent possessive relatives. German \mention{dessen} (whose) reportedly strands only under contrastive parallelism; Japanese independent genitives appear to require comparable discourse accessibility conditions. If these reports hold up, the constraints are not language-specific accidents. They're consequences of how filler-gap processing interacts with discourse accessibility~-- and those interactions should be universal.
