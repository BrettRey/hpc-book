...
This brings a base-rate problem: what if the licensing contexts themselves are rare?
...
In practice, these tests translate into specific research designs: psycholinguistic tasks (reaction time, eye-tracking, ERPs) for processing facilitation; sampling across register ecologies for distributional coherence; controlled acceptability work designed to manipulate licensing contexts; historical corpus comparison for diachronic change; computational causal interventions for mechanism isolation. The tests are not philosophical abstractions; they are guides to experimental and corpus-analytic practice.
