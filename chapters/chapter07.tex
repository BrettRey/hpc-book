...
Five mechanisms braid together to maintain quotatives. Some are cognitive (processing economy), some functional (expressive fit), some developmental (acquisition and cohort effects), some social (indexing and transmission). Each contributes, but none is sufficient alone.
