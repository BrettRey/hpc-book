...
Quotatives introduce reported speech, thought, gesture, or sound. Every language needs them. But when we look across typologically unrelated languages, we find a striking convergence: in the late twentieth century, similar forms emerged, spread through similar populations, and stabilised through similar mechanisms. Japanese \mention{tte}, Turkish \mention{diye}, German \mention{so}, English \mention{be like} -- different sources, different structures, but the same functional niche, the same stabilising dynamics.
