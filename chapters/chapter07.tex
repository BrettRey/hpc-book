...
%
% NOTE: Add forward reference to agent-based modelling (ABM). How the mechanisms
% interact—whether alignment can override entrenchment, whether transmission
% bottlenecks can shift basin boundaries—is an empirical question. ABM offers one
% route; point readers to Chapter 14 for the full methodological discussion.
%
