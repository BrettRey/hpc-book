...
First, mechanisms are not excuses for hand-waving. Saying \enquote{entrenchment maintains the category} is not an explanation unless you can specify what entrenchment is, how it operates, and what predictions it makes. The framework is only as good as the mechanisms it identifies are measurable and manipulable.
