...
\toprule
\textbf{Mechanism attenuated} & \textbf{Frequency} & \textbf{Judgment variance} & \textbf{Social meaning} & \textbf{Cross-context transfer} & \textbf{Historical trajectory} \\
\midrule
...
\addlinespace
Transmission blocked & rapid $\downarrow$ & --- & fossilised & retained (in speakers) & arrested \\
\bottomrule
\end{tabular}
