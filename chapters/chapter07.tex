...
The case studies in this chapter aren't meant to supersede the work they draw on: Remijsen's descriptive fieldwork on under-documented languages, Ferrara and Bell's functional analysis of quotative emergence, Bybee's usage-based account of frequency and entrenchment, Tagliamonte's variationist quantification of change in progress, Buchstaller's cross-variety typology, or Huddleston and Pullum's meticulous descriptive grammar. That work provides the data~-- the primary documentation, the functional distinctions, the processing mechanisms, the apparent-time percentages, the global attestation patterns, the fine-grained distributional facts. The maintenance view provides a conceptual frame that makes the data cohere.
