...
In the triadic terms of Chapter~\ref{ch:the-category-zipper}:

\begin{itemize}
    \item \textbf{Form}: the deitality cluster~-- \mention{there}-resistance, partitive eligibility, nonrestrictive hosting.
    \item \textbf{Object}: the definiteness construal~-- identifiability, uniqueness, familiarity.
    \item \textbf{Interpretant}: the inferential habit~-- expectations about reference tracking, anaphoric availability, and what the hearer can pick out.
\end{itemize}

What couples form and object is the interpretant: when you hear \mention{the}, you expect an identifiable referent; when you construe something as identifiable, you mark it. The habit of inference is what pulls the teeth together. Where the interpretant is stable, the coupling is tight; where it varies (weak definites, proper names), the zipper slips.
