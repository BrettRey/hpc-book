...
\ea[]{\label{ex:there-bad}\ungram{\mention{There is the key/my key on the table.}}}
\z
...
\z
\ea[]{\label{ex:part-bad}\ungram{\mention{Two of some students left.}}}
\z
...
\paragraph{Stress tests.} (i) If weak definites cluster with token-referring definites in embedding space rather than forming a distinct subcluster, reclassify deitality as a thin pattern within definiteness. (ii) If the form-cluster diagnostics fragment completely~-- \mention{there}-resistance, partitive licensing, and hosting showing no correlation~-- there is no form cluster to explain.
