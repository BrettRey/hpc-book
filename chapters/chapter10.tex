...
Each uses \mention{the}, but none involves the standard uniqueness or familiarity. These aren't marginal exceptions; they're high-frequency, fully productive patterns \citep{carlsonsussman2005,poesio1994}. A theory of \mention{the} that treats them as anomalies risks missing the systematicity of the pattern.
...
\begin{exe}
    \ex \label{ex:host-good} \textit{The/This/My book, which I bought yesterday...}
    \ex \label{ex:host-bad} \textit{?A/Some book, which I bought yesterday...}
\end{exe}
...
The form cluster is maintained by causal mechanisms operating at different timescales. I'll walk us through five of them. Each contributes to the cluster's stability; together they explain why the pattern persists despite constant pressure from analogy and variation.

\subsection{Grammaticalization (decades and centuries)}
