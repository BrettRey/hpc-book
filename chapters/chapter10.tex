...
\paragraph{Acquisition (childhood).}
...
\paragraph{Alignment (seconds to minutes).}
...
\paragraph{Prestige selection (years to decades).}
...
\paragraph{Transmission (generations).}
