...
Like the spinning top (Chapter~\ref{ch:kinds-without-essences}), the stability is dynamic, maintained by active forces rather than static rigidity. The homeostatic mechanisms are exactly these stabilizing forces. They don't define the boundaries~-- that would be essentialism~-- but they maintain the landscape geometry.
