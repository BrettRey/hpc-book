...
\textbf{Iterated transmission} acts as a filter across generations. Not all variants survive; the ones that do tend to be clear exemplars well inside basins. As \citet{kirby2008} demonstrated, transmission bottlenecks select for learnable structures. In their experimental evolution of artificial languages, random mappings became compositional over ten generations because the bottleneck of imperfect learning filtered out the arbitrary variants (Figure~\ref{fig:iterated-learning}).
