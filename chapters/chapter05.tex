...
This is not evasion. There is a principled way to construct such metrics for heterogeneous feature spaces. The strategy, familiar from statistical ecology and clustering analysis, proceeds in two steps \citep[cf.][]{gower1971}.
...
For this picture, imagine the landscape as fixed and the dot for \mention{fun} moving across it: in 1900 it sits securely in the noun basin; by 2020 it has climbed partway up the ridge toward the adjective basin.

In reality, of course, the landscape itself is not static. As more words and constructions accumulate adjective-like properties in this region, they collectively deepen and widen the adjective basin and erode the ridge between noun and adjective, turning it into a gentler pass. The category system is both the terrain that constrains a lexeme's motion and a product of where masses of lexemes have settled over time.
