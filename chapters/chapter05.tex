...
Geoff Pullum said yes. On Wednesday, Ryan Nefdt said yes~-- and added something I hadn't thought of:
...
\begin{axis}[
    ...
    height=6cm,
    xlabel={Decade},
    ylabel={Tokens in COHA},
    xmin=1860, xmax=2020,
    ymin=0, ymax=60,
    xtick={1870,1900,1930,1960,1990,2010},
...
\addplot[thick, mark=*, blue] coordinates {
    (1940,1) (1950,2) (1960,3) (1970,9) (1980,6) (1990,25) (2000,37) (2010,52)
};
\addlegendentry{\mention{really fun}}

% so fun
\addplot[thick, mark=square*, red] coordinates {
    (1970,1) (1990,8) (2000,11) (2010,34)
};
\addlegendentry{\mention{so fun}}

% rather fun
\addplot[thick, mark=triangle*, orange] coordinates {
    (1900,3) (1910,5) (1920,2) (1930,7) (1940,5) (1950,7) (1960,7) (1970,3) (1980,1) (1990,2) (2000,2)
};
\addlegendentry{\mention{rather fun}}

% very fun
\addplot[thick, mark=diamond*, purple] coordinates {
    (1870,1) (1940,1) (1960,1) (1980,2) (1990,3) (2000,6) (2010,12)
};
\addlegendentry{\mention{very fun}}

\end{axis}
\end{tikzpicture}
\caption{Degree-modified \mention{fun} in the Corpus of Historical American English. \mention{Really fun} and \mention{so fun} surge from the 1980s onward; \mention{rather fun} peaks earlier and declines; \mention{very fun} rises late. The diagnostics co-move in the late twentieth century, consistent with productive adjectivalisation.}
\label{fig:fun-coha}
\end{figure}
