...
\begin{tikzpicture}
\pgfplotsset{
    colormap={grayheat}{gray(0cm)=(1); gray(1cm)=(0.3)},
}
\begin{axis}[
    width=0.9\textwidth,
    height=4.5cm,
    ...
    ytick={1,2,3,4},
    yticklabels={\textit{very fun},\textit{rather fun},\textit{so fun},\textit{really fun}},
    yticklabel style={font=\small},
    xlabel={},
    ylabel={},
    enlargelimits=false,
]
% Data matrix: rows = modifiers (bottom to top: very, rather, so, really)
...
\addplot[matrix plot*, mesh/cols=12, point meta=explicit] coordinates {
    ...
    % rather fun: steady early, declines
    (1,2) [0]  (2,2) [3]  (3,2) [5]  (4,2) [2]  (5,2) [7]  (6,2) [5]  (7,2) [7]  (8,2) [7]  (9,2) [3]  (10,2) [1]  (11,2) [2]  (12,2) [2]
    % so fun: late surge
    (1,3) [0]  (2,3) [0]  (3,3) [0]  (4,3) [0]  (5,3) [0]  (6,3) [0]  (7,3) [0]  (8,3) [0]  (9,3) [1]  (10,3) [0]  (11,3) [8]  (12,3) [45]
    % really fun: late surge
    (1,4) [0]  (2,4) [0]  (3,4) [0]  (4,4) [0]  (5,4) [0]  (6,4) [1]  (7,4) [2]  (8,4) [3]  (9,4) [9]  (10,4) [6]  (11,4) [25]  (12,4) [52]
};
\end{axis}
\end{tikzpicture}
