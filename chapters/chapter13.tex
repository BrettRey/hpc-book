...
\epigraph{\textit{The same explanatory strategy tolerates different cuts.}}{--- William Croft (personal communication)}
...
\ex.\label{ex:letalone} I wouldn't live in Cleveland, let alone Detroit.
...
\ex.[\ungram{}] I would live in Cleveland, let alone Detroit.
