...
This is homeostasis in action~-- or rather, homeostasis failing. The merger is not random noise; it's a predictable consequence of perturbing the stabilising mechanisms. Where cue reliability decreases, the category boundary destabilizes.
...
\subsection{The $\langle$-ed$\rangle$ paradigm}
