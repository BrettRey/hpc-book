...
To say what's being coupled, we need a term that works across grains. We've already met the term \emph{value}~-- what a unit counts as in the system when deployed, its contrastive role, recoverable by competent users. Here it does heavy lifting.
