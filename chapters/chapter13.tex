...
In this domain, projectibility is practical: if you understand one tracking pattern, you can make good bets about the next reference move.
...
The architecture is shared; the hardware is not.
...
In this setting, homeostasis shows up as repair under load rather than abandonment of reference tracking.
