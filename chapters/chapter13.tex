...
Composite coupling is where the interpretant does the most visible work. The unit is not merely retrieved; it must be inferred as a coherent gestalt. The stabilizers that matter are therefore the ones that protect that composition: cue redundancy, norm enforcement, and genre licensing.
