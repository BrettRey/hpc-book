...
The HPC framework would be toothless if it said yes to everything. These negative cases illustrate ways a smart reader might try to overgeneralize the zipper. Here are three cases where it says no~-- each for a different reason.
