...
The rest of Part I completes the diagnosis. Chapter 2 examines the systematic failures of essentialism~-- from \mention{furniture} to weak definites~-- showing why the default view cannot be saved by minor tweaks. Chapter 3 argues that the nominalist retreat to prototypes and feature bundles throws out the baby with the bathwater, losing the explanation of stability. Chapter 4 counts the cost, showing how this foundational confusion has stalled specific research programs in typology and theory.
