...
The striking thing isn't that words misbehave. It's that they misbehave in ways that persist, replicate across speakers, and survive centuries. The puzzle isn't classification. The puzzle is stability~-- why the instability is itself stable.
