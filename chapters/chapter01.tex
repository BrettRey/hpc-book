...
The argument throughout will be that grammatical categories are real, stable, and explanatorily powerful~-- not because they have essences, but because mechanisms hold them together. The boundaries are genuinely fuzzy~-- not because categories are merely convenient fictions, but because mechanisms weaken, compete, and overlap. The gradience and the stability are two sides of the same coin.
