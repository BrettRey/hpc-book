...
Call this the \term{maintenance view}. The hypothesis is that categories are real because they are maintained. The full argument will have to wait for Chapter~\ref{ch:categories-without-essences}; for now, the point is only that neither essentialism nor prototype theory can even ask the question.
