...
Second, it validates \textbf{methodological pluralism}. If subfields are valid HPCs, then \enquote{pure} linguistics is just one bundle among many~-- usually the bundle that privileges introspective data and structural economy. Other bundles (corpus linguistics, sociolinguistics) privilege different stabilizers (usage data, social variation). These aren't failed attempts at pure linguistics; they are different cuts through the same multidimensional reality. This answers \textcite{nefdt2023}'s worry that methodological pluralism leads to ontological chaos. It doesn't. We can have many methods and many territories, as long as they all map to valid homeostatic clusters. The unity isn't in the objects; it's in the criteria for kindhood.
