...
\mention{Quickly}. \mention{Absolutely}. \mention{However}. \mention{Frankly}. \mention{Moreover}. \mention{Somewhat}. \mention{Therefore}. \mention{Certainly}. \mention{Otherwise}.

What do these words have in common? The dictionary says they're adverbs. But what does that mean? They modify different things: \mention{quickly} modifies manner, \mention{very} modifies degree, \mention{frankly} signals speaker stance, \mention{however} organises discourse, \mention{therefore} marks inference. Their distributions overlap only partially. Their semantic contributions share almost nothing. The label \mention{adverb} gathers them like socks in a drawer---not by what they are, but by what they aren't. They're not nouns; they're not verbs; they're not adjectives. What remains is the bin.
