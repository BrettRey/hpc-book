...
These properties cluster. When a referent is bounded, it's usually atomic; when it's atomic, it's usually enumerable; when it's enumerable, it usually resists homogeneous subdivision. The clustering isn't accidental. But it is not absolute. A \mention{ball bearings} is maximally individuated: bounded, atomic, enumerable. But a \mention{cloud} is bounded while lacking stable atomicity. \mention{Cattle} denotes discrete animals, but the noun construes them as an aggregate. The cluster represents a prototype, not a rigid definition.
