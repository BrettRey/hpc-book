...
These properties cluster. When a referent is bounded, it's usually atomic; when it's atomic, it's usually enumerable; when it's enumerable, it usually resists homogeneous subdivision. The clustering isn't accidental. But it is not absolute. A cloud is bounded but lacks stable atomicity. The referents of \term{furniture} are atomic, yet the category treats them as unbounded substance.
