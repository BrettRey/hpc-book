...
And there's a prior question underneath. Not whether \mention{English} is a category but whether \term{language\ixsq{language!as category}} is~-- the capacity that English, Nicaraguan Sign Language, and a deaf child's homesign are instances of. The essentialist tradition lists design features or nominates recursion; the HPC\ixsq{homeostatic property cluster!language} reframing asks what cluster~-- symbolic reference, combinatorial syntax, cultural transmission, open-ended productivity~-- is maintained by what mechanisms, and where the maintenance thins. Homesign and trained-ape communication sit at the boundary because the mechanisms are partially present, not because an essence is partially instantiated.

Those are other books. What matters here is that the framework doesn't flinch at either question. If \mention{English} names a maintained cluster that projects~-- that supports induction about what a new speaker will do, what a new text will look like, what a child acquiring it will converge on~-- then it's a category in the same sense that \mention{noun} is: real at the scale where the maintenance operates, dissolving where it doesn't.
