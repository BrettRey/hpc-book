...
\newglossaryentry{perturbationsensitivity}{
  ...
  description={\glsdef{The diagnostic that a category frays when a stabilizer is weakened.} \glsmech{Observed when interventions target acquisition, alignment, or transmission.} \glsdiag{Predictable degradation patterns under perturbation.} \glsnote{Operationalises homeostasis.} \glsxsee{homeostasis, stabilizer.}}
}
