...
% =========================
% 7×10 trim with classical Van de Graaf/Tschichold proportions
\usepackage[
  paperwidth=7in,paperheight=10in,
  inner=0.778in,     % 1/9 width
  outer=1.556in,     % 2/9 width
  top=1.111in,       % 1/9 height
  bottom=2.222in,    % 2/9 height
...
\hyphenation{Huddleston Pullum Langacker Goldberg Chomsky Labov Haspelmath
  ...
  homeostatic projectibility entrenchment grammaticalisation}
...
% =========================
% MICROTYPE (XeLaTeX: protrusion works)
% =========================
...
% Chapter: restrained but unmistakable
...
% Section/subsection: real bold now that the font supports it
\titleformat{\section}
