...
\newcommand{\ixlgq}[3]{\index[lexical]{#1@\textit{#2} (#3)}\index[languages]{#3!Lexical items!#1@\textit{#2}}} % Lexical + language co-index
\newcommand{\ixlgqs}[4]{\index[lexical]{#1@\textit{#2} (#3, ``#4'')}\index[languages]{#3!Lexical items!#1@\textit{#2} (``#4'')}} % Lexical + language + gloss
