...
% Rosarivo: Google Fonts serif (Regular + Italic only; AutoFakeBold for bold)
\setmainfont{Rosarivo}[
  Path=/Users/brettreynolds/Library/Fonts/,
  UprightFont=Rosarivo-Regular.ttf,
  ItalicFont=Rosarivo-Italic.ttf,
  AutoFakeBold=1.5
]
...
% Macro for IPA transcriptions and extended Latin
% Usage: \ipa{ɪ} or \ipa{pʰɪt} for IPA that Rosarivo can't render
