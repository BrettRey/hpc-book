...
\section*{What you'll be able to do with this}

The practical payoff is diagnostic vision. You should be able to see why forms that look like noise can be stable systems (\mention{there's}\ixlq{there's} as a presentative particle), why apparently exceptional patterns are often boundary effects rather than breakdowns (weak definites such as \mention{go to the hospital}\ixlq{hospital}), and why some familiar labels track real maintained structure while others are mostly filing convenience. The aim isn't just a new vocabulary; it's a clearer way to decide what counts as a category claim that earns predictive trust.
...
What it is, instead, is a contribution to the \term{foundations of linguistics}~-- the study of what linguistic categories are, what makes them real, and what kind of evidence bears on those questions. The book sits at the intersection of linguistics, philosophy of science, and cognitive science. It asks what categories are made of, and it answers: mechanisms, not essences.
...
\noindent\textit{Mississauga, January 2026}
